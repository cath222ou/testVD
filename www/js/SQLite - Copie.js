//moment.locale();  //
	  ...
	  // Wait for Cordova to load
		...
		function populateDB(tx) {
            tx.executeSql('CREATE TABLE IF NOT EXISTS DEMO (id INTEGER PRIMARY KEY AUTOINCREMENT,dateValue,name,number)');
        }
        ...
        function querySuccess(tx, results) {
            var tblText='<table id="t01"><tr><th>ID</th> <th>Date</th> <th>Name</th> <th>Number</th></tr>';
            ...
            for (var i = 0; i < len; i++) {
                ...
                tblText +='<tr onclick="goPopup('+ tmpArgs + ');"><td>' 
						...
						+ results.rows.item(i).number +'</td></tr>';
            }
            tblText +="</table>";
		...
		function insertDB(tx) {
            tx.executeSql('INSERT INTO DEMO (dateValue,name,number) VALUES ("'+ newdate +'","'+ name1 +'","'+ number1 +'")');
        }
